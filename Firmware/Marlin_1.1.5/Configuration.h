...
#define STRING_CONFIG_H_AUTHOR "(UT2017, ANYCUBIC)" // Who made the changes.
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { 10, 10, (Z_MIN_POS + 1)}
  #define NOZZLE_CLEAN_END_POINT   {80, 40, (Z_MIN_POS + 1)}
