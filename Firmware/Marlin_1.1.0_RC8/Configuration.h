...
/*
 *  TEMPLATE for ANYCUBIC Prusa I3 with Trigorilla Board
 *
 *  !! BOTH Z motors are plugged into the Z driver !!
 *  
 *  This config uses an inductive probe as Z endswitch. Be sure to 
 *  check all settings to match with your printer build. 
 *
 */
...
#define STRING_CONFIG_H_AUTHOR "(Marlin, Version1_1_0_RC8)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 8000, 8000, 50, 10000 }
 ...
 * #define Z_PROBE_END_SCRIPT "G1 Z10 F200\nG1 X30 Y30\nG1 Z0.5\nG1 Z10"
 */
#define Z_PROBE_END_SCRIPT "G1 Z10 F200\nG0 X30 Y30 F6000"
...
//  #define NOZZLE_PARK_POINT {  10, 10, 50 }
#endif
